...
public class Encap_04 {
	...
	public static void main(String[] args) {
		...
		if (choice.equals("y")) {
			...
			switch (opt) {
			case 1:
				property.setRatePerSqFt(8000);
				break; // example rupees per sq.ft
			case 2:
				property.setRatePerSqFt(3500);
				break;
			case 3:
				property.setRatePerSqFt(1200);
				break;
			default:
				property.setRatePerSqFt(2000);
				break;
			}
...
class Property {
	...
	public void setArea(double areaSqFt) {
		if (areaSqFt < 0)
			throw new IllegalArgumentException("Area negative nahi ho sakta.");
	...
	public void setRatePerSqFt(double ratePerSqFt) {
		if (ratePerSqFt < 0)
			throw new IllegalArgumentException("Rate negative nahi ho sakta.");
